import { useSSRContext, useSlots, useModel, computed, watch, toRef, unref, withCtx, mergeProps, renderSlot, openBlock, createBlock, createCommentVNode, createTextVNode, toDisplayString, createVNode, mergeModels, resolveDynamicComponent, Fragment, renderList, defineComponent, toHandlers, reactive } from 'vue';
...
import { k as useRoute, i as useLocale, a as useAppConfig, b as useComponentUI, d as getSlotChildrenText, t as tv, h as _sfc_main$8$1, f as _sfc_main$9$1, n as isArrayOfArray, c as _sfc_main$b$1, o as _sfc_main$c$1, e as _sfc_main$d$1, g as get, p as pickLinkProps, q as _sfc_main$a$1, j as usePortal, l as useFieldGroup, m as useComponentIcons, r as useState } from './server.mjs';
import { _ as _sfc_main$d } from './Container-CiACrIZ8.mjs';
                    ...
                    if (_push3) {
                      ...
                      return [
                        renderSlot(_ctx.$slots, item.slot ? `${item.slot}-trailing` : "item-trailing", {
                          ...
                          __props.orientation === "horizontal" && (item.children?.length || !!slots[item.slot ? `${item.slot}-content` : "item-content"]) || __props.orientation === "vertical" && item.children?.length ? (openBlock(), createBlock(_sfc_main$d$1, {
                            key: 1,
                            name: item.trailingIcon || __props.trailingIcon || unref(appConfig).ui.icons.chevronDown,
                            "data-slot": "linkTrailingIcon",
                            class: ui.value.linkTrailingIcon({ class: [unref(uiProp)?.linkTrailingIcon, item.ui?.linkTrailingIcon], active })
                          }, null, 8, ["name", "class"])) : item.trailingIcon ? (openBlock(), createBlock(_sfc_main$d$1, {
                            key: 2,
                            name: item.trailingIcon,
                            "data-slot": "linkTrailingIcon",
                            class: ui.value.linkTrailingIcon({ class: [unref(uiProp)?.linkTrailingIcon, item.ui?.linkTrailingIcon], active })
              ...
              renderSlot(_ctx.$slots, item.slot || "item", {
                ...
                renderSlot(_ctx.$slots, item.slot ? `${item.slot}-leading` : "item-leading", {
                  ...
                  item.avatar ? (openBlock(), createBlock(_sfc_main$b$1, mergeProps({
                    ...
                    _: 2
                  }, 1040, ["size"])) : item.icon ? (openBlock(), createBlock(_sfc_main$d$1, {
                    key: 2,
                    name: item.icon,
                    "data-slot": "linkLeadingIcon",
                    class: ui.value.linkLeadingIcon({ class: [unref(uiProp)?.linkLeadingIcon, item.ui?.linkLeadingIcon], active, disabled: !!item.disabled })
                ...
                unref(get)(item, props.labelKey) || !!slots[item.slot ? `${item.slot}-label` : "item-label"] ? (openBlock(), createBlock("span", {
                  ...
                  item.target === "_blank" && __props.externalIcon !== false ? (openBlock(), createBlock(_sfc_main$d$1, {
                    key: 0,
                    name: typeof __props.externalIcon === "string" ? __props.externalIcon : unref(appConfig).ui.icons.external,
                    "data-slot": "linkLabelExternalIcon",
                    class: ui.value.linkLabelExternalIcon({ class: [unref(uiProp)?.linkLabelExternalIcon, item.ui?.linkLabelExternalIcon], active })
                                                      ...
                                                      if (_push8) {
                                                        _push8(ssrRenderComponent(_sfc_main$a$1, mergeProps({ ref_for: true }, childSlotProps, {
                                                          ...
                                                          default: withCtx((_4, _push9, _parent9, _scopeId8) => {
                                                            if (_push9) {
                                                              if (childItem.icon) {
                                                                _push9(ssrRenderComponent(_sfc_main$d$1, {
                                                                  name: childItem.icon,
                                                              ...
                                                              return [
                                                                childItem.icon ? (openBlock(), createBlock(_sfc_main$d$1, {
                                                                  key: 0,
                                                                  name: childItem.icon,
                                                                  "data-slot": "childLinkIcon",
                                                                  class: ui.value.childLinkIcon({ class: [unref(uiProp)?.childLinkIcon, item.ui?.childLinkIcon], active: childActive })
                                                                ...
                                                                createVNode("span", {
                                                                  ...
                                                                  childItem.target === "_blank" && __props.externalIcon !== false ? (openBlock(), createBlock(_sfc_main$d$1, {
                                                                    key: 0,
                                                                    name: typeof __props.externalIcon === "string" ? __props.externalIcon : unref(appConfig).ui.icons.external,
                                                                    "data-slot": "childLinkLabelExternalIcon",
                                                                    class: ui.value.childLinkLabelExternalIcon({ class: [unref(uiProp)?.childLinkLabelExternalIcon, item.ui?.childLinkLabelExternalIcon], active: childActive })
                                                ...
                                                if (_push7) {
                                                  _push7(ssrRenderComponent(_sfc_main$a$1, mergeProps({ ref_for: true }, childSlotProps, {
                                                    ...
                                                    default: withCtx((_4, _push8, _parent8, _scopeId7) => {
                                                      if (_push8) {
                                                        if (childItem.icon) {
                                                          _push8(ssrRenderComponent(_sfc_main$d$1, {
                                                            name: childItem.icon,
                                                            "data-slot": "childLinkIcon",
                                                            class: ui.value.childLinkIcon({ class: [unref(uiProp)?.childLinkIcon, item.ui?.childLinkIcon], active: childActive })
...
//# sourceMappingURL=default-CMTO811k.mjs.map

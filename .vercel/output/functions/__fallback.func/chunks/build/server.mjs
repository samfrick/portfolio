import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { computed, ref, watch, createVNode, resolveDynamicComponent, unref, mergeProps, withCtx, renderSlot, openBlock, createBlock, toDisplayString, useSlots, inject, createCommentVNode, toRef, hasInjectionContext, toValue, useModel, createTextVNode, mergeModels, isRef, defineComponent, shallowRef, h, resolveComponent, provide, getCurrentInstance, onServerPrefetch, defineAsyncComponent, createElementBlock, cloneVNode, useSSRContext, shallowReactive, Suspense, Fragment, createApp, renderList, useId, onErrorCaptured, reactive, effectScope, nextTick, useTemplateRef, withModifiers, getCurrentScope, markRaw, isReadonly, isShallow, isReactive, toRaw } from 'vue';
import { s as serialize, m as klona, n as defu, p as parseQuery, o as defuFn, q as isEqual, r as hasProtocol, l as joinURL, v as parseURL, x as encodePath, y as decodePath, w as withQuery, z as isScriptProtocol, A as getContext, B as withTrailingSlash, C as withoutTrailingSlash, D as sanitizeStatusCode, $ as $fetch$1, E as baseURL, i as createError$1, F as executeAsync } from '../_/nitro.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'vue-router';
import { Icon, getIcon, loadIcon as loadIcon$1, _api, addAPIProvider, setCustomIconsLoader } from '@iconify/vue';
import colors from 'tailwindcss/colors';
import { ssrRenderVNode, ssrRenderComponent, ssrRenderSlot, ssrRenderClass, ssrInterpolate, ssrRenderList, ssrRenderSuspense, ssrRenderStyle } from 'vue/server-renderer';
...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import('./about-pxeMkx_4.mjs')
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./contact-Cz61x6gM.mjs')
  },
  {
    name: "projects",
    path: "/projects",
    component: () => import('./projects-CQp1Q9Ly.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-CFyOVMTC.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-CMTO811k.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BHwWmls1.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-iv29u2cb.mjs'));
...
export { __nuxt_component_0$1 as _, useAppConfig as a, useComponentUI as b, _sfc_main$b as c, getSlotChildrenText as d, entry_default as default, _sfc_main$d as e, _sfc_main$9 as f, get as g, _sfc_main$8 as h, useLocale as i, usePortal as j, useRoute as k, useFieldGroup as l, useComponentIcons as m, isArrayOfArray as n, _sfc_main$c as o, pickLinkProps as p, _sfc_main$a as q, useState as r, tv as t, useHead as u };
